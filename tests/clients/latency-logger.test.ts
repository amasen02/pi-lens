...
vi.mock("../../clients/ndjson-logger.js", () => ({
	...
	// #2506: latency-logger.ts now builds its writer via createLazyNdjsonLogger
	// (deferred first-call construction, not a module-import-time freeze) —
	// this mock must cover both factories or importing latency-logger.js
	// throws "No createLazyNdjsonLogger export" before any test body runs.
